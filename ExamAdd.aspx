<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExamAdd.aspx.cs" Inherits="ExamLibrary.ExamAdd" %>
    ...
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td class="style2">
                <asp:Button ID="ButtonSavePaper" runat="server" Text="添加试题" Width="83px" 
                    onclick="ButtonSavePaper_Click" />
            </td>
            <td class="style1">
