...
{
    public partial class ExamEditor : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            LabelTipPaper.Text = "尊敬的" + Convert.ToString(Session["user"]) + "老师，您正在编辑的是 " + cno + " 课程，所在章节是章节编号为 " + chapternum + " ；章节名为：" + chaptername;
        }
    }
}